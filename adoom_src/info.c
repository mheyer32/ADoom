...
char *sprnames[NUMSPRITES + 1] = {
    ...
    "SMRT", "HDB1", "HDB2", "HDB3", "HDB4", "HDB5", "HDB6", "POB1", "POB2", "BRS1", "TLMP", "TLP2", NULL};

// Doesn't work with g++, needs actionf_p1
// MH: I think this is evil, we're pretending for all these functions to have actionf_p1 type,
// and hope for the linker to not notice
void A_Light0(void *);
